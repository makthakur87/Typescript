...
export default defineConfig({
  ...
  // globalSetup: "./src/setup/global-login.setup.ts",
  ...
  use: {
    ...
    // storageState: "storageState.json", // Use the storage state generated by globalSetup to maintain the logged-in state across tests
